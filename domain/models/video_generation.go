...
type VideoGeneration struct {
	...
	GenerateAudio  *bool `gorm:"type:boolean;default:true" json:"generate_audio,omitempty"`
	EnableSubtitle *bool `gorm:"type:boolean;default:false" json:"enable_subtitle,omitempty"`
