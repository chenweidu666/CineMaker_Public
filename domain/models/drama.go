...
type Drama struct {
	...
	GenerateAudio *bool          `gorm:"default:true" json:"generate_audio"`
...
type Character struct {
	...
	OutfitName       *string        `gorm:"type:varchar(100)" json:"outfit_name"`
	Role             *string        `gorm:"type:varchar(50)" json:"role"`
	Gender           *string        `gorm:"type:varchar(20)" json:"gender"`
	AgeDescription   *string        `gorm:"type:varchar(100)" json:"age_description"`
	Description      *string        `gorm:"type:text" json:"description"`
	...
	ImageOrientation *string        `gorm:"type:varchar(20)" json:"image_orientation"` // "horizontal" or "vertical"
	...
	Parent   *Character  `gorm:"foreignKey:ParentID" json:"parent,omitempty"`
	Children []Character `gorm:"foreignKey:ParentID" json:"children,omitempty"`
...
type Storyboard struct {
	...
	Description      *string        `gorm:"type:text" json:"description"`
	PrevShotRef      *string        `gorm:"type:text" json:"prev_shot_ref"`
	FirstFrameDesc   *string        `gorm:"type:text" json:"first_frame_desc"`
	MiddleActionDesc *string        `gorm:"type:text" json:"middle_action_desc"`
	LastFrameDesc    *string        `gorm:"type:text" json:"last_frame_desc"`
...
type Scene struct {
	...
	EpisodeID        *uint          `gorm:"index:idx_scenes_episode_id" json:"episode_id"`
	Name             *string        `gorm:"type:varchar(200)" json:"name"`
	Location         string         `gorm:"type:varchar(200);not null" json:"location"`
	Time             string         `gorm:"type:varchar(100)" json:"time"`
	Description      *string        `gorm:"type:text" json:"description"`
	Atmosphere       *string        `gorm:"type:text" json:"atmosphere"`
	Lighting         *string        `gorm:"type:varchar(200)" json:"lighting"`
	Sound            *string        `gorm:"type:varchar(200)" json:"sound"`
	SceneType        *string        `gorm:"type:varchar(50)" json:"scene_type"`
	Prompt           string         `gorm:"type:text" json:"prompt"`
	StoryboardCount  int            `gorm:"default:1" json:"storyboard_count"`
	ImageURL         *string        `gorm:"type:varchar(500)" json:"image_url"`
	LocalPath        *string        `gorm:"type:text" json:"local_path"`
	ReferenceImages  datatypes.JSON `gorm:"type:json;default:'[]'" json:"reference_images"`
	ImageOrientation *string        `gorm:"type:varchar(20);default:'horizontal'" json:"image_orientation"`
	SeedValue        *string        `gorm:"type:varchar(100)" json:"seed_value"`
	Status           string         `gorm:"type:varchar(20);default:'pending'" json:"status"`
	CreatedAt        time.Time      `gorm:"not null;autoCreateTime" json:"created_at"`
	UpdatedAt        time.Time      `gorm:"not null;autoUpdateTime" json:"updated_at"`
