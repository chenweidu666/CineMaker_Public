...
| **AI 服务** | 火山引擎全链路 | Doubao 文本 / Seedream 图片 / Seededit 编辑 / Seedance 视频 / Doubao Vision |
...
flowchart TB
    ...
    subgraph ai ["🤖 AI 服务（火山引擎）"]
        ...
        VisionAI["Doubao Vision<br/>视觉理解"]
    end
...
flowchart TD
    ...
    VideoAnalysis["视频分析<br/>/video-analysis"]
...
| 视频分析 | `VideoAnalysis.vue` | 五阶段流水线、实时进度、一键导入剧本 |
...
| **视频分析** | 五阶段流水线（FFprobe + BigASR + Vision），一键导入为剧本 |
