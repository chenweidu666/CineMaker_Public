...
(async () => {
  ...
  try {
    ...
    // Drama 13: 都市女孩的惬意时光与归乡期待
    await page.locator('.project-card').filter({ hasText: '都市女孩的惬意时光与归乡期待' }).first().click();
    await page.waitForURL(/\/dramas\/[^/]+$/, { timeout: 8000 });
    await page.getByRole('tab', { name: /角色/ }).click();
    await page.waitForTimeout(2000);
    await page.screenshot({ path: `${OUT}/layout-drama13.png`, fullPage: false });
    console.log('Saved layout-drama13.png');
    ...
    await page.getByRole('tab', { name: /角色/ }).click();
    await page.waitForTimeout(2000);
    await page.screenshot({ path: `${OUT}/layout-drama2.png`, fullPage: false });
    console.log('Saved layout-drama2.png');
  } catch (e) {
