...
(async () => {
  ...
  try {
    ...
    await page.screenshot({ path: `${OUT}/unified-drama2.png`, fullPage: false });
    console.log('Saved unified-drama2.png');
    ...
    await page.getByRole('tab', { name: /角色/ }).click();
    await page.waitForTimeout(2000);
    await page.screenshot({ path: `${OUT}/unified-drama13.png`, fullPage: false });
    console.log('Saved unified-drama13.png');
  } catch (e) {
