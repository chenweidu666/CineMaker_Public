export default {
  ...
  aiConfig: {
    ...
    form: {
      ...
      baseUrlTip: 'API 服务的基础地址，如 OpenAI: https://api.openai.com/v1，Gemini: https://generativelanguage.googleapis.com（无需 /v1）',
      fullEndpoint: '完整调用路径',
      apiKey: 'API Key',
  ...
  drama: {
    ...
    empty: '暂无剧本，点击上方按钮创建剧本',
    emptyHint: '点击上方"创建剧本"按钮开始您的第一部短剧',
    editProject: '编辑项目',
    projectName: '项目名称',
  ...
  character: {
    ...
    saveChanges: '保存修改',
    nextStep: '下一步：生成角色图片',
    extractTitle: '从剧本提取角色',
    selectEpisode: '选择章节',
    extractTip: 'AI将分析剧本内容，自动提取角色信息',
    startExtract: '开始提取'
  },
  prop: {
    title: '道具管理',
  ...
  editor: {
    ...
    panelCount: '格数',
    prompt: '提示词',
    extractPrompt: 'AI提取提示词',
    promptPlaceholder: '点击AI提取提示词按钮，系统将根据分镜内容生成图片提示词...',
    generating: '生成中...',
    generateImage: '生成图片',
    uploadImage: '上传图片',
