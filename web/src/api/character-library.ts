...
export const characterLibraryAPI = {
  ...
  // AI生成角色形象
  generateCharacterImage(characterId: string, model?: string, prompt?: string, referenceImages?: string[], style?: string) {
    return request.post<{ image_url: string; prompt: string }>(`/characters/${characterId}/generate-image`, {
      model,
      prompt,
      style,
