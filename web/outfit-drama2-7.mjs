...
(async () => {
  ...
  try {
    ...
    await page.screenshot({ path: `${OUT}/outfit-drama2.png`, fullPage: false });
    console.log('Saved outfit-drama2.png');
    ...
    await page.getByRole('tab', { name: /角色/ }).click();
    await page.waitForTimeout(2000);
    await page.screenshot({ path: `${OUT}/outfit-drama7.png`, fullPage: false });
    console.log('Saved outfit-drama7.png');
  } catch (e) {
